...
ALL_PATIENTS_DIR =  os.path.join(DATA_DIR, 'train', 'train') # change this depending on validation or training data


# checks for file overwrite
SAVENAME = os.path.join(DATA_DIR, 'train', 'train_mri_{}_{}_N{}.h5'.format(X_DIM, Y_DIM, N_PATIENTS))
...
fail_name = os.path.join(DATA_DIR, 'train', 'failedPatients_train_N{}.csv'.format(N_PATIENTS))
...
#%%
import pandas as pd
train_file = 'C:\\Users\\Znerp\\Documents\\GitHub\\kaggle-dsb2-keras\\data\\train\\train.csv'
